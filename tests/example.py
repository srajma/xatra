...
map.BaseOption("Esri.WorldTerrain")
map.BaseOption("Esri.WorldShadedRelief")
map.BaseOption("Stadia.StamenWatercolor")
map.BaseOption("Stadia.StamenTerrainBackground")
map.BaseOption("Esri.OceanBasemap")
...
map.Flag(label="Gupta/Gujarat", value=gadm("IND.11"), period=[400,600], type="vassal")
map.Flag(label="Gupta/Mahārāṣṭra", value=gadm("IND.20"), period=[300,400], type="vassal")
map.Flag(label="Gupta/Akāravanti", value=gadm("IND.19"), period=[150,500], type="province")
map.Flag(label="Muslim/Delhi", value=gadm("IND.25") | gadm("IND.34"), period=[1200,1500], type="vassal")
map.Flag(label="Muslim/Mughal", value=NORTH_INDIA, period=[1500,1700], type="vassal")
...
#controls, #controls input {width:40%;}
