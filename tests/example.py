...
map.Flag(label="Delhi", period=[1200,1500], parent="Muslim")
map.Flag(label="Mughal", period=[1500,1700], parent="Muslim")
map.Flag(label="Deccan", period=[1400,1600], parent="Muslim")
