...
map.Flag(label="Gupta/Gujarat", value=gadm("IND.11"), period=[400,600])
map.Flag(label="Gupta/Mahārāṣṭra", value=gadm("IND.20"), period=[300,400])
map.Flag(label="Gupta/Akāravanti", value=gadm("IND.19"), period=[150,500])
map.Flag(label="Muslim/Delhi", value=gadm("IND.25") | gadm("IND.34"), period=[1200,1500])
map.Flag(label="Muslim/Mughal", value=NORTH_INDIA, period=[1500,1700])
map.Flag(label="Muslim/Deccan", value=gadm("IND.2") | gadm("IND.16") | gadm("IND.32"), period=[1400,1600])
