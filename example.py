...
map.Flag(label="Chola", value=gadm("IND.31") | gadm("IND.17"), period=[600, 650])
...
map.River(label="Ganga2", value=naturalearth("1159122643"), period=[0, 600], note="Modern course of Ganga", classes="modern-river")
