...
INDIC = Map(
    ...
    geojson_rivers=Varuna.INDIAN_SUBCONTINENT.load(),
    custom_colors=_custom_colors,
)

SILKRD = Map(
    flags=_flags,
    geojson=Loka.SILKRD.load(),
    geojson_rivers=Varuna.SILKRD.load(),
    custom_colors=_custom_colors,
    std_start = "Meru"
)
...
WORLD = Map(
    flags=_flags,
    geojson=Loka.WORLD.load(),
    geojson_rivers=Varuna.WORLD.load(),
    custom_colors=_custom_colors,
    std_start = "Meru",
)
